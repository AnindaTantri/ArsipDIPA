            ...
            <div class="card-body">
              ...
              <form action="prosesedit.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select id="inputState" class="form-select" name="kategori">
                      ...
                      }else if($data['kategori']=='Pengumuman'){
                        echo "<option>Undangan</option>
                        <option selected>Pengumuman</option>
                        <option>Nota Dinas</option>
                        <option>Pemberitahuan</option>";
                      }else if($data['kategori']=='Nota Dinas'){
                        echo "<option>Undangan</option>
                        <option>Pengumuman</option>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="file" name="file" class="form-control" value="<?php echo $data['file']?>">
                  </div>
                </div>
                <div class="text-left"><?php echo $data['file']?></div>
                <iframe src="<?php echo $data['file']?>" width="100%" style="height:100%"></iframe>
                <div class="text-left">
                  <a href="index.php"><button type="button" class="btn-secondary"><< Kembali</button></a>
